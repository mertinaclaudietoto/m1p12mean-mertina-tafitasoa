...
const DEFAULTDATA = [
  {
    model: CarType,
    data: [
      {_id:new Types.ObjectId("000000000000000000000001"), name: "Berline", percentage: 100 },
      {_id:new Types.ObjectId("000000000000000000000002"), name: "Break", percentage: 95 },
      {_id:new Types.ObjectId("000000000000000000000003"), name: "Coupé", percentage: 80 },
      {_id:new Types.ObjectId("000000000000000000000004"), name: "Cabriolet", percentage: 75 },
      {_id:new Types.ObjectId("000000000000000000000005"), name: "Hatchback", percentage: 92 },
      {_id:new Types.ObjectId("000000000000000000000006"), name: "Limousine", percentage: 93 },
      {_id:new Types.ObjectId("000000000000000000000007"), name: "SUV", percentage: 94 },
      {_id:new Types.ObjectId("000000000000000000000008"), name: "Crossover", percentage: 97 },
      {_id:new Types.ObjectId("000000000000000000000009"), name: "Pick-up", percentage: 98 },
      {_id:new Types.ObjectId("000000000000000000000010"), name: "Monospace", percentage: 91 },
    ],
  },
  {       
    model: engineTypes,
    data: [
      {_id:new Types.ObjectId("000000000000000000000001"), name: "Essence", percentage: 91 },
      {_id:new Types.ObjectId("000000000000000000000002"), name: "Diesel", percentage: 95 },
      {_id:new Types.ObjectId("000000000000000000000003"), name: "Hybride Série", percentage: 88 },
      {_id:new Types.ObjectId("000000000000000000000004"), name: "Hybride Parallèle", percentage: 93 },
      {_id:new Types.ObjectId("000000000000000000000005"), name: "Hybride Plug-in", percentage: 83 },
      {_id:new Types.ObjectId("000000000000000000000006"), name: "Électrique CC", percentage: 84 },
      {_id:new Types.ObjectId("000000000000000000000007"), name: "Électrique Synchrone", percentage: 85 },
      {_id:new Types.ObjectId("000000000000000000000008"), name: "Électrique Asynchrone", percentage: 86 },
      {_id:new Types.ObjectId("000000000000000000000009"), name: "Hydrogène", percentage: 96 },
      {_id:new Types.ObjectId("000000000000000000000010"), name: "Rotatif", percentage: 100 },
      {_id:new Types.ObjectId("000000000000000000000011"), name: "Gaz Naturel", percentage: 78 },
      {_id:new Types.ObjectId("000000000000000000000012"), name: "Biocarburant", percentage: 79 },
    ],
  },
  {
    model: Emp,
  ...
  },
  {
    model: sizeTypes,
    data: [
      { _id: new Types.ObjectId("000000000000000000000001"), name: "Small", percentage: 80 },
      { _id: new Types.ObjectId("000000000000000000000002"), name: "Medium", percentage: 78 },
      { _id: new Types.ObjectId("000000000000000000000003"), name: "Large", percentage: 77 },
    ],    
  },
  {
    model: weigthTypes,
    data: [
      { _id: new Types.ObjectId("000000000000000000000001"), name: "Light", percentage: 93 },
      { _id: new Types.ObjectId("000000000000000000000002"), name: "Medium", percentage: 89 },
      { _id: new Types.ObjectId("000000000000000000000003"), name: "Heavy", percentage: 90 },
    ],    
  },
  {
    model: Rule,
